...
public class WelcomeController {
    ...
    public void playButtonClicked(ActionEvent actionEvent) throws IOException {
        Parent playViewParent = FXMLLoader.load(getClass().getResource("../fxmls/chooseGame.fxml"));
    ...
    public void scoresButtonClicked(javafx.event.ActionEvent actionEvent) throws IOException  {
        Parent scoresViewParent = FXMLLoader.load(getClass().getResource("../fxmls/scores.fxml"));
    ...
    public void podiumButtonClicked(ActionEvent actionEvent) throws IOException {
        Parent scoresViewParent = FXMLLoader.load(getClass().getResource("../fxmls/podium.fxml"));
        Scene scoresScene = new Scene(scoresViewParent);
        Stage window = (Stage) ((Node)actionEvent.getSource()).getScene().getWindow();
        window.setScene(scoresScene);
        window.show();
